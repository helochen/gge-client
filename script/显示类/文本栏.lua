...
-- @Last Modified time: 2021-04-15 20:58:26
--======================================================================--
local 场景类_文本栏 = class()
local tp
...
function 场景类_文本栏:显示(dt,x,y)
	...
	self.介绍文本:显示(self.x  + 12,self.y + 25)
end
