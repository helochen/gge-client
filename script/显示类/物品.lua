...
-- @Last Modified time: 2020-01-28 14:08:46
--======================================================================--
local 内存类_物品 = class()
...
local function 取套装效果(tz)
    if
        tz == '盘丝阵' or tz == '定心术' or tz == '极度疯狂' or tz == '金刚护法' or tz == '逆鳞' or tz == '生命之泉' or tz == '魔王回首' or
            tz == '幽冥鬼眼' or
            tz == '楚楚可怜' or
            tz == '百毒不侵' or
            tz == '变身' or
     ...
     then
        return '附加状态'
    elseif
        tz == '知己知彼' or tz == '似玉生香' or tz == '三味真火' or tz == '日月乾坤' or tz == '镇妖' or tz == '尸腐毒' or tz == '阎罗令' or
            tz == '百万神兵' or
            tz == '勾魂' or
            tz == '判官令' or
            tz == '雷击' or
