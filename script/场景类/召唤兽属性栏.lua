...
function 场景类_召唤兽属性栏:加载数据()
	...
	self.资源组 = {
		...
		[30] = 资源:载入(tp.造型背景,"网易WDF动画",0xA19838E8),--宠物显示框
			...
			self.资源组[25]:置方向(0)
		     ...
		     local qq = wp()
		      ...
		      if tp.队伍[1].宝宝列表[self.选中].饰品.染色方案~=nil then
				self.资源组[25]:置染色(tp.队伍[1].宝宝列表[self.选中].饰品.染色方案,tp.队伍[1].宝宝列表[self.选中].饰品.染色组[1],tp.队伍[1].宝宝列表[self.选中].饰品.染色组[2],tp.队伍[1].宝宝列表[self.选中].饰品.染色组[3])
				self.资源组[25]:置方向(0)
		      end
		end
