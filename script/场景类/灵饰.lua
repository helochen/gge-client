...
-- @Last Modified time: 2021-03-01 18:37:16
--======================================================================--
local 场景类_灵饰 = class()
...
function 场景类_灵饰:加载数据()
	...
	self.资源组 = {
		...
		[4] = 资源:载入(tp.灵饰背景,"网易WDF动画",0x841CBD61),
		[5] = 资源:载入(tp.灵饰背景,"网易WDF动画",0x9912E8B9),
		[6] = 资源:载入(tp.灵饰背景,"网易WDF动画",0x5795605E),
		[7] = 资源:载入(tp.灵饰背景,"网易WDF动画",0xEBD8985D),
		[8] = 资源:载入(tp.灵饰背景,"网易WDF动画",0xEBD8985D),
	}
	self.资源组[2]:绑定窗口_(36)
	self.物品 = {}
	local 格子 = tp._物品格子
	for i=1,5 do
		self.物品[i] = 格子(0,0,i,"道具行囊_灵饰",tp.物品背景)
	end
end
...
function 场景类_灵饰:显示(dt,x,y)
	...
	for i=1,5 do
		...
		xx = xx + 1
		self.资源组[3+i]:显示(self.x + xx * 58-47.5+xs,self.y + yy * 57-30)
