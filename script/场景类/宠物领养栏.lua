...
-- @Last Modified time: 2020-09-12 21:17:27
--================,======================================================--
...
function 场景类_宠物领养栏:加载数据()
	...
	self.资源组 = {
		...
		[3] = 按钮.创建(资源:载入('wzife.wdf',"网易WDF动画",0x2BD1DEF7),0,0,4,true,true,"领养"),
...
function 场景类_宠物领养栏:显示(dt,x,y)
	...
	--[[	tp.宠物.模型 = self.宠物说明[self.选中宠物][1]
		tp.宠物.名称 = self.宠物说明[self.选中宠物][1]
		tp.宠物.等级 = 1
		tp.宠物.最大等级 = 40
		tp.宠物.耐力 = 5
		tp.宠物.最大耐力 = 5
	...
	zts1:置字间距(2)
	zts1:显示(self.x+243,self.y+3,"宠物领养")
	zts1:置字间距(0)
