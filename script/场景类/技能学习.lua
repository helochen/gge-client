...
-- @Last Modified time: 2020-08-23 04:05:54
--======================================================================--
...
function 场景类_技能学习:加载数据()
	...
	self.资源组 = {
		...
		[8] = 按钮.创建(自适应.创建(12,4,72,22,1,3),0,0,4,true,true,"学习十次"),
	}
	for n=2,7 do
		self.资源组[n]:绑定窗口_(22)
	end
...
function 场景类_技能学习:显示(dt,x,y)
	...
	self.资源组[8]:更新(x,y,self.选中 ~= 0 and tp.队伍[1].师门技能[self.选中].等级 < 180,1)
	self.焦点 = false
	if self.鼠标 then
	...
	self.资源组[7]:显示(self.x + 50,self.y + 440,true)
	self.资源组[8]:显示(self.x + 254,self.y + 440,true)
