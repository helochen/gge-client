...
-- @Last Modified time: 2022-11-11 09:38:51
...
local function _RGB565to888(p16, p32, alpha)
    ...
    p32[0] = _bor(_lshift(b, 3), _rshift(b, 2))
     --B
    p32[1] = _bor(_lshift(g, 2), _rshift(g, 4))
     --G
    p32[2] = _bor(_lshift(r, 3), _rshift(r, 2))
     --R
    p32[3] = alpha or 255
end
