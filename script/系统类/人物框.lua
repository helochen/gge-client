...
function 系统类_人物框:加载()
    ...
    self.人物头像背景 = {}
    self.小图标 = {
        资源:载入('wzife.wdf', '网易WDF动画', 0x24901650),
        资源:载入('wzife.wdf', '网易WDF动画', 0x09E2B01B),
        资源:载入('wzife.wdf', '网易WDF动画', 0x397B8CF6),
        资源:载入('wzife.wdf', '网易WDF动画', 0x397B8CF6),
        资源:载入('xzsc.wdf', '网易WDF动画', 0xAC4486C4)
    }
    self.图标组 = {}
    self.焦点 = false
    self.队伍头像 = {}
...
function 系统类_人物框:显示(dt, x, y)
    ...
    local yy = 0
    for n = 1, #self.图标组 do
        self.图标组[n][1]:显示(全局游戏宽度 - 148 + xx * 30, 58)
        --附加物品效果显示
