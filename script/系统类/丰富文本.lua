...
function 丰富文本类:初始化(...)
	...
	self.文字 		= require("gge文字类").创建():置行间距(1)
	self.文字宽度,self.文字高度 	= 7,15
	self.行间距 		= 1
	self.元素表 		= {P=0xFF00ffff,W=0xFFFFFFFF,H=0xFF000000,Y=0xFFFFFF00,L=-16776961,R=0xFFFF6666,G=4278255360,S=-16466190,Z=-16711681,N=-16777216,C=ARGB(255,125,125,125),F=0xFFFF1493}
	self.显示表 		= {高度 = 0,宽度 = 0}
	--亮金黄色：FFFAFAD2
