...
-- @Last Modified time: 2020-08-23 02:40:08
--======================================================================--
local 自适应 = class()
-- 载入UI自适应区域
local 适应组 = {}
...
function 自适应:加载(根)--37
	local 资源 = 根.资源
	适应组[0] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0xb0025203).精灵} -- UI的背景底图
	适应组[37] = {[0]=资源:载入('wzife.wd4',"网易WDF动画",0XEC7E6D12).精灵} -- 老商城背景   ---没用
	适应组[1] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x12989E68).精灵} -- UI的后置标题背景
	适应组[72] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x003C5980).精灵} -- UI的后置标题背景
	适应组[28]= {[0]=资源:载入('wzife.wd4',"网易WDF动画",0x802EB60A).精灵}  --对话透明悬浮
	适应组[2] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x2ed21261).精灵} -- UI的按钮背景
	适应组[3] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0xB74E6CA1).精灵} -- 梦幻的输入背景
	适应组[4] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x4BC7BD91).精灵} -- UI的提示方块背景
	适应组[9] = {[0]=资源:载入('wzife.wd4',"网易WDF动画",0xF5B6E157).精灵} -- 梦幻的风格喊话背景
	适应组[5] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x550F8EF4).精灵} -- 梦幻的文字信息栏背景
	适应组[6] = {[0]=资源:载入('wzife.wd4',"网易WDF动画",0xB5FDF1AC).精灵} -- 梦幻的文字信息栏背景
	适应组[7] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x314C04D8).精灵} -- 梦幻的文字信息栏背景
	...
	适应组[34] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0xb2e469d2).精灵} -- UI的按钮背景 加分割条
	适应组[35] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0x4E5F661E).精灵} -- 梦幻的滑块分割条小   [17] = 自适应.创建(31,1,14,210,2,0),  self.资源组[17]:置颜色(-16777216)
	适应组[36] = {[0]=资源:载入('uisj.wdf',"网易WDF动画",0xEA6D0A4D).精灵} -- 梦幻的滑块分割条大 hen
	-- 按钮组
	适应组[10] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xCD9700B7)}
	适应组[11] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x88E9B473)}
	适应组[12] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x1a106d6a)}
	适应组[13] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x8438F1FD)} -- 精致按钮
	--分区--########################################################?自己修改?##########################################
	...
	-- * 不可组合按钮组
	适应组[18] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xF11233BB)} -- 关闭按钮
	适应组[19] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x787dd2bb)} -- 单独的方块小按钮
	适应组[20] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xFD3D61F2)} -- 上翻
	适应组[21] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x09217E13)} -- 下翻
	适应组[22] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xB05126E8)} -- 道具左翻
	适应组[23] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x26066130)} -- 道具右翻
	适应组[24] = {按钮=资源:载入('wzife.wdf',"网易WDF动画",0xBAF6A95D)} -- 灯笼
	适应组[25] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xC47885C6)} -- 加点加
	适应组[26] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0x5E0D32BF)} -- 加点减
	适应组[27] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xb0217ecb)} -- 分页按钮
	适应组[29] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xC9BF8D1E)} -- 方形的打钩按钮
	适应组[30] = {按钮=资源:载入('uisj.wdf',"网易WDF动画",0xB5D15C45)} -- 圆形的打钩按钮
	...
	tp.窗口标题背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0xC69BF9F3).精灵
	tp.物品界面背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0xF70725E9).精灵
	tp.物品格子背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0xB17505CF).精灵
	tp.竖排花纹背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0xEA6D0A4D).精灵
	tp.横排花纹背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0xEA6D0A4D).精灵
	tp.宽竖排花纹背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0x2D0F136C).精灵
	tp.宠物头像背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0x363AAF1B).精灵
	tp.人物头像背景_ = 资源:载入('uisj.wdf',"网易WDF动画",0x360B8373).精灵

	tp.技能背景 = 资源:载入('uisj.wdf',"网易WDF动画",0x68D384BD)
	tp.小技能背景 = 资源:载入('uisj.wdf',"网易WDF动画",0xC28E86D1)
	tp.打勾框='uisj.wdf'
	tp.头像背景='uisj.wdf'
	tp.物品背景=资源:载入('uisj.wdf',"网易WDF动画",0xA393A808)



	if tp.窗口~=nil then
			tp.窗口.UI_底图=资源:载入('uisj.wdf',"网易WDF动画",0x3D1FA249)
