...
-- @Last Modified time: 2021-04-20 04:46:38
...
function 取地图名称(id)
	...
	elseif id == 1150 then
		return "凌波城"
	elseif id == 1116 or id == 6100 then
		return "龙宫"
	elseif id == 1117 then
		return "水晶宫"
	elseif id == 1122 then
...
function 小地图资源加载(map)
	...
	elseif map == 1116 or map == 6100 then
		return 'smap.wdf',545106797
	elseif map == 6101 then
		return 'smap.wdf',3579377767
	elseif map == 6102 then
	...
	elseif map == 1251 then
		return 'smap.wdf',0xD2629476
	elseif map == 1249 then
		return 'smap.wdf',0xD2629475
	elseif map == 1250 then
		return 'smap.wdf',0xD2629474
	elseif map == 1259 then
	      return 'smap.wdf',0xD2629477

	elseif map == 2003 then--浮华雪山
	     return 'smap.wdf',0x6965A199
